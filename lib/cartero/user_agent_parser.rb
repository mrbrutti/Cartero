module Cartero
    ...
    def parse_engine
      ...
      when /msoffice 12/              then "Microsoft Word 12"
      when /msoffice 14/              then "Microsoft Word 14"
    ...
    def parse_platform
      ...
      when /ipad/                   then "iPad"
      when /windows nt/i            then 
        @ua.scan(/x64/) == 0 ? "Generic x86 32-bit PC" : "Generic x86 64-bit PC"
